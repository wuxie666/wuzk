...
public class UserController {
    ...
    @PostMapping
    public String createUser(@ToolParam(description = "用户实体") @RequestBody User user) {
    ...
    @PutMapping
    public String updateUser(@ToolParam(description = "用户实体") @RequestBody User user) {
    ...
    @DeleteMapping("/{id}")
    public String deleteUser(@ToolParam(description = "用户ID") @PathVariable Long id) {
